...
instance_count=0
nb_classes=2
chunk_size= 1385  #  change this for separate cases   11_04 -- 729   11_03 -- 329  08-02 -- 1056
seq_length = 10
nfeat = 1024
...
for i in range(loop):
    ...
    keylist2=[]
    for i in key2:
        if (i > 2000):         # change the limits for training <4000 to train 11_04 and 11_03,  >2000 to train 11_03 and 08_02,  <2000 and >4000 to train 11_04 and 08_02
            newkey2 = str(i)
            # print(newkey2)
...
for chunk in chunks(sorted(keys), 5):   # change the value of 2 for different cases --- to train on 11_04 and 11_03 = 2 , other cases try 5
...
keylist2=[]
for i in key2:
    if (i < 2000):                # change limits of indices for other cases
        newkey2 = str(i)
        keylist2.append(newkey2)
